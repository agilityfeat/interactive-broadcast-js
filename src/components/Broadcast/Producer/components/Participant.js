...
import { isFan, getRoleTranslation } from '../../../../services/util';
...
const getHeaderLabel = (type: string): string => R.toUpper(getRoleTranslation(type));
    ...
    <div className="Participant">
      ...
      { isBackstageFan(type) ?
        <div className="Participant-move-fan">
          <button className="move btn transparent" onClick={sendFanToStage}>Move to {getRoleTranslation('fan')} feed</button>
        </div> :
